...
# 🌲 파일 구조 트리
<details>
<summary><b>&nbsp;Assets 파일 구조</b></summary>
<div markdown=1>
📦assets<br/>
 ┣ 📂image<br/>
 ┃ ┣ 📜테스트케이스_로그인_로그인계정확인.png<br/>
 ┃ ┣ 📜테스트케이스_로그인_로그인성공.png<br/>
 ┃ ┣ 📜테스트케이스_로그인_로그인실패.png<br/>
 ┃ ┣ 📜테스트케이스_마이페이지_비밀번호재설정1.png<br/>
 ┃ ┣ 📜테스트케이스_마이페이지_비밀번호재설정2.png<br/>
 ┃ ┣ 📜테스트케이스_마이페이지_비밀번호재설정3.png<br/>
 ┃ ┣ 📜테스트케이스_사용자 등급 변경_등급 6으로 수정.png<br/>
 ┃ ┣ 📜테스트케이스_사용자 등급 변경_등급 수정 트리거.png<br/>
 ┃ ┣ 📜테스트케이스_사용자 등급 변경_등급 수정 프로시저.png<br/>
 ┃ ┣ 📜테스트케이스_사용자_복구요청.png<br/>
 ┃ ┣ 📜테스트케이스_사용자_복구요청결과.png<br/>
 ┃ ┣ 📜테스트케이스_사용자계정찾기_비밀번호찾기성공.png<br/>
 ┃ ┣ 📜테스트케이스_사용자계정찾기_비밀번호찾기실패.png<br/>
 ┃ ┣ 📜테스트케이스_사용자계정찾기_아이디찾기성공.png<br/>
 ┃ ┣ 📜테스트케이스_사용자계정찾기_아이디찾기실패.png<br/>
 ┃ ┣ 📜테스트케이스_사용자계정탈퇴.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_블랙리스트 등록 및 삭제.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 계정 복구.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 계정 삭제.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 목록 조회하기.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 신고 기록 조회.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 활동 기록 삭제.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 활동 기록 조회_게시글.png<br/>
 ┃ ┣ 📜테스트케이스_사용자관리_사용자 활동 기록 조회_댓글.png<br/>
 ┃ ┣ 📜테스트케이스_사용자정보조회.png<br/>
 ┃ ┣ 📜테스트케이스_사용자활동조회_사용자게시글조회.png<br/>
 ┃ ┣ 📜테스트케이스_사용자회원정보수정_공개여부.png<br/>
 ┃ ┣ 📜테스트케이스_사용자회원정보수정_닉네임.png<br/>
 ┃ ┣ 📜테스트케이스_사용자회원정보수정_알림설정.png<br/>
 ┃ ┣ 📜테스트케이스_사용자회원정보수정_프로필사진.png<br/>
 ┃ ┣ 📜테스트케이스_사용자회원정보수정_한줄소개.png<br/>
 ┃ ┣ 📜테스트케이스_사용자회원정보수정_회원.png<br/>
 ┃ ┣ 📜테스트케이스_성향검사_성향검사결과조회.png<br/>
 ┃ ┣ 📜테스트케이스_성향검사_성향검사결과추가1.png<br/>
 ┃ ┣ 📜테스트케이스_성향검사_성향검사결과추가2.png<br/>
 ┃ ┣ 📜테스트케이스_성향검사_성향재검사.png<br/>
 ┃ ┣ 📜테스트케이스_알림_알림설정.png<br/>
 ┃ ┣ 📜테스트케이스_알림_알림설정거부.png<br/>
 ┃ ┣ 📜테스트케이스_캘린더_사용자 opu 조회.png<br/>
 ┃ ┣ 📜테스트케이스_캘린더_사용자 성취율 조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_게시글좋아요수조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_게시글좋아요취소.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_게시글좋아요표시.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_공지사항_검색조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_공지사항_게시글목록조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_공지사항_게시글삭제.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_공지사항_게시글상세조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_공지사항_게시글수정.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_공지사항_게시글추가.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_답글조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_답글추가.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글삭제.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글수정.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글좋아요수조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글좋아요취소.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글좋아요표시.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_댓글추가.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_검색조회1.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_검색조회2.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_게시글목록조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_게시글삭제.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_게시글상세조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_게시글수정.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_게시글추가.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_자유게시판_팔로잉우선조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_검색조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_게시글 삭제.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_게시글목록조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_게시글상세조회.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_게시글수정.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_게시글추가.png<br/>
 ┃ ┣ 📜테스트케이스_커뮤니티_후기_팔로잉우선조회.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_다른사용자프로필조회.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_사용자팔로우.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_팔로우취소.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_팔로워관계삭제.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_팔로워목록조회.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_팔로잉관계삭제.png<br/>
 ┃ ┣ 📜테스트케이스_프로필_팔로잉목록조회.png<br/>
 ┃ ┣ 📜테스트케이스_회원가입1.png<br/>
 ┃ ┗ 📜테스트케이스_회원가입2.png<br/>
 ┣ 📂images<br/>
 ┃ ┣ 📜Conceptual ERD.png<br/>
 ┃ ┣ 📜Flow Chart.png<br/>
 ┃ ┣ 📜Logo.png<br/>
 ┃ ┣ 📜Main Page.png<br/>
 ┃ ┣ 📜Physical ERD.png<br/>
 ...
 ┣ 📂setting<br/>
 ┃ ┗ 📜외래키제약스크립트.md<br/>
 ┗ 📜한화be15_1st_project_erd.damx<br/>
 </div>
 </details>

<details>
<summary><b>&nbsp;SQL 파일 구조</b></summary>
<div markdown=1>
📦sql<br>
 ┣ 📂DDL<br>
 ┃ ┗ 📜SQLscript_full_version.sql<br>
 ┣ 📂admin<br>
 ┃ ┣ 📜system_management.sql<br>
 ┃ ┗ 📜user_management.sql<br>
 ┣ 📂calender<br>
 ┃ ┗ 📜month_calender.sql<br>
 ┣ 📂community<br>
 ┃ ┣ 📜comments.sql<br>
 ┃ ┣ 📜free_board.spf<br>
 ┃ ┣ 📜free_board.sql<br>
 ...
 ┃ ┗ 📜review_board.sql<br>
 ┣ 📂initial_data<br>
 ┃ ┗ 📜SQLscript_initial.sql<br>
 ┣ 📂notify<br>
 ┃ ┗ 📜notification.sql<br>
 ┣ 📂opu_manage<br>
 ┃ ┣ 📜opu_management.sql<br>
 ┃ ┣ 📜opu_random.sql<br>
 ┃ ┗ 📜personality_test.sql<br>
 ┣ 📂user<br>
 ┃ ┣ 📜login.sql<br>
 ┃ ┣ 📜mypage.sql<br>
 ┃ ┣ 📜profile.sql<br>
...
![Image](https://github.com/user-attachments/assets/2faff31d-fdfb-4815-9e62-08b29b31caa5)
...
![Image](https://github.com/user-attachments/assets/e367dc8f-b41c-426d-a03a-76072c37acaf)
...
<img width="801" alt="Image" src="https://github.com/user-attachments/assets/74843eda-740c-494f-83c5-56d6f9ed6f50" />
<img width="800" alt="Image" src="https://github.com/user-attachments/assets/18bb4fa4-e5e8-4758-9de8-07cbe9e9e013" />
...
![alt text](assets/image/테스트케이스_회원가입2.png)

<li> 로그인

![alt text](assets/image/테스트케이스_로그인_로그인계정확인.png) 
![alt text](assets/image/테스트케이스_로그인_로그인성공.png) 
![alt text](assets/image/테스트케이스_로그인_로그인실패.png) 

<li> 계정 찾기

![alt text](assets/image/테스트케이스_사용자계정찾기_비밀번호찾기성공.png) 
![alt text](assets/image/테스트케이스_사용자계정찾기_비밀번호찾기실패.png) 
![alt text](assets/image/테스트케이스_사용자계정찾기_아이디찾기성공.png) 
![alt text](assets/image/테스트케이스_사용자계정찾기_아이디찾기실패.png) 

<li> 마이페이지

![alt text](assets/image/테스트케이스_사용자정보조회.png) 
![alt text](assets/image/테스트케이스_사용자활동조회_사용자게시글조회.png) 

<li> 회원 정보 수정

![alt text](assets/image/테스트케이스_사용자회원정보수정_공개여부.png) 
![alt text](assets/image/테스트케이스_사용자회원정보수정_닉네임.png) 
![alt text](assets/image/테스트케이스_사용자회원정보수정_알림설정.png) 
![alt text](assets/image/테스트케이스_사용자회원정보수정_프로필사진.png) 
![alt text](assets/image/테스트케이스_사용자회원정보수정_한줄소개.png) 
![alt text](assets/image/테스트케이스_사용자회원정보수정_회원.png)

<li> 등급 변경

![alt text](<assets/image/테스트케이스_사용자 등급 변경_등급 6으로 수정.png>) 
![alt text](<assets/image/테스트케이스_사용자 등급 변경_등급 수정 트리거.png>) 
![alt text](<assets/image/테스트케이스_사용자 등급 변경_등급 수정 프로시저.png>) 

<li> 비밀번호 재설정

![alt text](assets/image/테스트케이스_마이페이지_비밀번호재설정1.png) 
![alt text](assets/image/테스트케이스_마이페이지_비밀번호재설정2.png) 
![alt text](assets/image/테스트케이스_마이페이지_비밀번호재설정3.png) 

<li> 계정 탈퇴 & 복구 요청

![alt text](assets/image/테스트케이스_사용자계정탈퇴.png) 

![alt text](assets/image/테스트케이스_사용자_복구요청.png) 
![alt text](assets/image/테스트케이스_사용자_복구요청결과.png) 

<li> 프로필 & 팔로우

![alt text](assets/image/테스트케이스_프로필_다른사용자프로필조회.png) ![alt text](assets/image/테스트케이스_프로필_사용자팔로우.png) ![alt text](assets/image/테스트케이스_프로필_팔로우취소.png) ![alt text](assets/image/테스트케이스_프로필_팔로워관계삭제.png) ![alt text](assets/image/테스트케이스_프로필_팔로워목록조회.png) ![alt text](assets/image/테스트케이스_프로필_팔로잉관계삭제.png) ![alt text](assets/image/테스트케이스_프로필_팔로잉목록조회.png)
...
<details>
<summary>&nbsp;푸시 알림 기능</summary>
<div markdown=1>

[text](README.md) ![text](assets/image/테스트케이스_알림_알림설정.png) ![text](assets/image/테스트케이스_알림_알림설정거부.png)
...
![text](assets/image/테스트케이스_커뮤니티_자유게시판_검색조회1.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_검색조회2.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_게시글목록조회.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_게시글삭제.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_게시글상세조회.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_게시글수정.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_팔로잉우선조회.png) ![text](assets/image/테스트케이스_커뮤니티_자유게시판_게시글추가.png) 

<li> 후기

![text](assets/image/테스트케이스_커뮤니티_후기_팔로잉우선조회.png) ![text](assets/image/테스트케이스_커뮤니티_후기_게시글추가.png) ![text](assets/image/테스트케이스_커뮤니티_후기_게시글수정.png) ![text](assets/image/테스트케이스_커뮤니티_후기_게시글상세조회.png) ![text](<assets/image/테스트케이스_커뮤니티_후기_게시글 삭제.png>) ![text](assets/image/테스트케이스_커뮤니티_후기_게시글목록조회.png) ![text](assets/image/테스트케이스_커뮤니티_후기_검색조회.png) 

<li> 공지사항

![text](assets/image/테스트케이스_커뮤니티_공지사항_게시글목록조회.png) ![text](assets/image/테스트케이스_커뮤니티_공지사항_검색조회.png) ![text](assets/image/테스트케이스_커뮤니티_공지사항_게시글삭제.png) ![text](assets/image/테스트케이스_커뮤니티_공지사항_게시글상세조회.png) ![text](assets/image/테스트케이스_커뮤니티_공지사항_게시글수정.png) ![text](assets/image/테스트케이스_커뮤니티_공지사항_게시글추가.png) 

<li> 게시글 좋아요

![text](assets/image/테스트케이스_커뮤니티_게시글좋아요수조회.png) ![text](assets/image/테스트케이스_커뮤니티_게시글좋아요취소.png) ![text](assets/image/테스트케이스_커뮤니티_게시글좋아요표시.png) 

<li> 댓글 & 답글 

![text](assets/image/테스트케이스_커뮤니티_답글조회.png) ![text](assets/image/테스트케이스_커뮤니티_답글추가.png) ![text](assets/image/테스트케이스_커뮤니티_댓글삭제.png) ![text](assets/image/테스트케이스_커뮤니티_댓글수정.png) ![text](assets/image/테스트케이스_커뮤니티_댓글조회.png) ![text](assets/image/테스트케이스_커뮤니티_댓글좋아요수조회.png) ![text](assets/image/테스트케이스_커뮤니티_댓글좋아요취소.png) ![text](assets/image/테스트케이스_커뮤니티_댓글좋아요표시.png) ![text](assets/image/테스트케이스_커뮤니티_댓글추가.png) 
</div>
</details>
...
![text](<assets/image/테스트케이스_사용자관리_블랙리스트 등록 및 삭제.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 계정 복구.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 계정 삭제.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 목록 조회하기.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 신고 기록 조회.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 활동 기록 삭제.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 활동 기록 조회_게시글.png>) ![text](<assets/image/테스트케이스_사용자관리_사용자 활동 기록 조회_댓글.png>)
